...
my @analyses = ("thresc_hybrid", "thresc_metaback", "typestate_metaback","pointsto_libanalysis", "mustalias_libanalysis", "compotypestate", "typestate", "mustalias", "mustalias-td", "infernet", "compomustalias", "mustalias-tdbu","mustalias-bu", "cg-prune", "typeEnvCFA", "liboverlap", "composba", "composbaBaseline", "compoRTA", "compoCHA", "connection", "allocEnvCFA", "0cfa", "allocEnvCFAClients", "kCFAClients", "provenance-instr", "print-polysite", "provenance-temp", "softanalysis", "provenance-kcfa", "provenance-kobj", "provenance-kobj-composat", "provenance-typestate", "softrefine-kcfa", "kobj", "experiment", "mln-kobj", "mlnconvertor",
    "mln-kobj1", "mln-polysite-oracle", "mln-polysite-batch", "mln-polysite-inter", "mln-polysite-problem","mln-downcast-oracle", "mln-downcast-batch", "mln-downcast-problem", "mln-downcast-inter", "mln-polysite-precg-oracle", "mln-polysite-precg-problem","mln-downcast-precg-oracle", "mln-downcast-precg-problem","mln-datarace-oracle", "mln-datarace-batch", "mln-datarace-problem", "mln-datarace-inter", "mln-thresc-oracle", "mln-thresc-batch", "mln-thresc-inter", "incrsolver", "derivsz", "dlogwrapper", "incr-dtreedumper", "incr-summgenerator", "incr-domcdumper", "incr-libaxiomdumper", "mln-infoflow-oracle", "mln-infoflow-problem", "mln-infoflow-batch", "mln-infoflow-inter", "nullderef-maxsat");
