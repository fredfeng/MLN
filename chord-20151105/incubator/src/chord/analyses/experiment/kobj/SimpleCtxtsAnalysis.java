 ...
 */
// TODO(rg): rename this class to avoid confusions (there' another class with the same name)
@Chord(name = "exp-simple-pro-ctxts-java",
...
public class SimpleCtxtsAnalysis extends JavaAnalysis implements HasTimeout {
    ...
    @Override public void setTimeout(Timeout timeout) { this.timeout = timeout; }
}
